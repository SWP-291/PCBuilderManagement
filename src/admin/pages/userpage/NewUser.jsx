...
const NewUser = () => {
  ...
  const initialState = {
    ...
    const { fullname, email, phone, country, gender, password, address, avatar, isActive, roleId  } = state;
    ...
    <div className="container py-5 newUser">
      ...
      <form onSubmit={handleSubmit}>
        <Col md className="contentUser">
          ...
          <input type="text" name='fullname' value={state.fullname} onChange={handleInputChange} />
          {errors.fullname_err && <span className='error'>{errors.fullname_err}</span>}
        </Col>   
        <Row>
            <Col md className="contentUser">
        ...
        <Row>
            <Col md className="contentUser">
              ...
              <input type="text" name='phone' value={state.phone} onChange={handleInputChange} />
              {/* {errors.phone && <span className='error'>{errors.price_err}</span>} */}
            </Col>
            <Col md className="contentUser">
              <label htmlFor="country">Country: </label>
              <input type="text" name='country' value={state.country} onChange={handleInputChange} />
        ...
        <Row>
            <Col md className="contentUser">
              ...
              <input type="text" name="password" value={state.password} onChange={handleInputChange} />
        ...
        <Row>
            <Col md className="contentUser" id="check">
              <div>
                ...
                <input type="checkbox" name="isActive" checked={state.isActive} onChange={handleInputChange}/>
              </div>
            </Col>
        </Row>
        
        <Col md className="contentUser">
          <label htmlFor="roleId">Role ID (1: Customer, 2: Admin, 3: Employee): </label>
          <input type="number" name='roleId' value={state.roleId} onChange={handleInputChange} />
          {errors.roleId_err && <span className='error'>{errors.roleId_err}</span>}
        </Col>
