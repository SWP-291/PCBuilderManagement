...
export default function NewComponent() {
  ...
  const { name, image, price, summary, description, brandId, categoryId} = state;
      ...
      <form onSubmit={handleSubmit}>
        ...
        <Row>
            <Col md className="contentComponent">
              ...
              <input type="number" name='brandId' value={state.brandId} onChange={handleInputChange} />
              {errors.brandId_err && <span className='error'>{errors.brandId_err}</span>}
            </Col>
            <Col md className="contentComponent">
              <label htmlFor="categoryId">Category ID: </label>
              <input type="number" name='categoryId' value={state.categoryId} onChange={handleInputChange} />
              {errors.categoryId_err && <span className='error'>{errors.categoryId_err}</span>}
            </Col>
        </Row>
        
        <div className='form-button'>
        <Button type='submit'>{id ? "Update Component" : "Create Component"}</Button>
        </div>
